...
function Jobs() {
  return (
    <>
      ...
      <div className="jobs flex-col absolute right-5 top-38 overflow-auto h-80">
        <div className="rounded-md w-full my-5 bg-white px-4 py-4 shadow-md transition transform duration-500 cursor-pointer">
